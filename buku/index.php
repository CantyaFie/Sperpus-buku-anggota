            ...
            <tbody>
                <?php
                    ...
                    <tr>
                        ...
                        <td><?= $b['stok'] ?></td>
                        <td>
                            <a href="detail.php?id_buku=<?php echo $b['id_buku']; ?>" class="badge badge-success">Detail</a>
                            <a href="edit.php?id_buku=<?php echo $b['id_buku']; ?>" class="badge badge-danger">Edit</a>
