            ...
            <tbody>
                <?php
                    ...
                    <tr>
                        ...
                        <td><?= $a['kelas'] ?></td>
                        <td>
                            <a href="detail.php?id_anggota=<?php echo $a['id_anggota']; ?>" class="badge badge-success">Detail</a>
                            <a href="form-edit.php?id_anggota=<?php echo $a['id_anggota']; ?>" class="badge badge-danger">Edit</a>
